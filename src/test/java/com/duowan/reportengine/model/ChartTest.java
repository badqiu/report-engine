...
public class ChartTest {
	...
	public void before() {
		chart.setX("date");
		rows.add(newMap("date",DateConvertUtils.parse("1999-1-1", "yyyy-MM-dd")));
		rows.add(newMap("date",DateConvertUtils.parse("1999-1-3", "yyyy-MM-dd")));
		rows.add(newMap("date",DateConvertUtils.parse("1999-1-7", "yyyy-MM-dd")));
	}
