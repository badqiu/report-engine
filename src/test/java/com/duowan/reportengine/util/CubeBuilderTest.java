...
import com.duowan.reportengine.model.Cube;
import static com.duowan.reportengine.util.MapUtil.newMap;
...
public class CubeBuilderTest {
	...
	static {
		rows.add(newMap("tdate","2013-01-01","game","ddt","gameServer","s1","click",100,"login",100));
		rows.add(newMap("tdate","2013-01-02","game","ddt","gameServer","s2","click",200,"login",200));
		rows.add(newMap("tdate","2013-01-02","game","ddt","gameServer","s3","click",300,"login",300));
		rows.add(newMap("tdate","2013-01-01","game","sxd","gameServer","s1","click",100,"login",100));
		rows.add(newMap("tdate","2013-01-01","game","sxd","gameServer","s2","click",200,"login",200));
	}
	@Before 
	public void before() {
	}
