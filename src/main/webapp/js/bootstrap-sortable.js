...
(function ($) {
    ...
    function extractNumber(input) {
    	if(input) {
    		var temp1 = input.match(/[0-9\-.\s:]*/g);
    		var temp2 = temp1[0].match(/[-0-9.]*/g);
    		var  result = temp2.join("");
    		//alert("input:"+ input + " tmp1:"+temp1 + " temp2:"+temp2 + " result:"+result);
    		if(isBlank(result)) {
    			return input;
    		}
        ...
        $('table.sortable').each(function () {
            ...
            $this.find('td').each(function () {
                ...
                if ($this.attr('data-dateformat') != undefined) {
                    ...
                    $this.attr('data-value') === undefined && $this.attr('data-value', extractNumber($this.text()));
                }
            });
            $this.find('thead th').each(function (index) {
                var $this = $(this);
